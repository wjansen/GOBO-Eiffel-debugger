/* inspect.h generated by valac 0.26.2, the Vala compiler, do not modify */
...
typedef enum  {
	...
	GEDB_ROUTINE_FLAG_POLYMORPHY = 0x80,
...
gboolean gedb_routine_is_polymorph (GedbRoutine *self);
